...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<addressable>.freeze, [">= 2.1.1".freeze])
  s.add_development_dependency(%q<em-spec>.freeze, ["~> 0.2.6".freeze])
  s.add_development_dependency(%q<eventmachine>.freeze, ["~> 0.12.10".freeze])
  s.add_development_dependency(%q<em-http-request>.freeze, ["~> 0.2.6".freeze])
